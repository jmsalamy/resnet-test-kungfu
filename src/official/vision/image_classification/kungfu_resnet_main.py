...
# ==============================================================================
"""Runs a ResNet model on the ImageNet dataset using KungFu to distribute training across GPUs."""
...
def run(flags_obj):
    ...
    optimizer = SynchronousSGDOptimizer(opt,reshape_strategy=False, use_locking=True)
